...
MainMenu::MainMenu()
{
    ...
    constexpr float logo_size_y = 443;
    ...
    (new GuiImage(this, "LOGO", "logo_full_patries"))->setPosition(0, title_y, ATopCenter)->setSize(logo_size_x, logo_size_y);
    (new GuiLabel(this, "VERSION", "Version: " + string(VERSION_NUMBER), 20))->setPosition(0, title_y + logo_size, ATopCenter)->setSize(0, 20);

    (new GuiButton(this, "START_SERVER", "Demarrer serveur", [this]() {
        new EpsilonServer();
        if (game_server)
        {
    ...
    (new GuiButton(this, "START_CLIENT", "Demarrer client", [this]() {
    ...
    (new GuiButton(this, "START_TUTORIAL", "Apprentissage", [this]() {
        new TutorialMenu();
        destroy();
    ...
    {
        (new GuiButton(this, "TOUCH_CALIB", "Calibrage\nEcran Tactile", [this]() {
            destroy();
            new MouseCalibrator("");
    ...
    (new GuiButton(this, "", "TO DA GM!", [this]() {
        ...
        if (game_server)
        {
            gameGlobalInfo->startScenario("scenario_00_transark_empty.lua");
