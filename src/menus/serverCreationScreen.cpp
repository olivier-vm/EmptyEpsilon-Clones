...
ServerCreationScreen::ServerCreationScreen()
{
    ...
    // General section.
    (new GuiLabel(left_panel, "GENERAL_LABEL", "Configuration serveur", 30))->addBackground()->setSize(GuiElement::GuiSizeMax, 50);
    ...
    row->setSize(GuiElement::GuiSizeMax, 50);
    (new GuiLabel(row, "PASSWORD_LABEL", "Mot de passe serveur: ", 30))->setAlignment(ACenterRight)->setSize(250, GuiElement::GuiSizeMax);
    ...
    (new GuiLabel(left_panel, "PLAYER_SHIP_LABEL", "Option vaisseau participant", 30))->addBackground()->setSize(GuiElement::GuiSizeMax, 50);
    ...
    row = new GuiAutoLayout(left_panel, "", GuiAutoLayout::LayoutHorizontalLeftToRight);
    row->setSize(GuiElement::GuiSizeMax, 50);
    (new GuiLabel(row, "RADAR_LABEL", "Portee radar: ", 30))->setAlignment(ACenterRight)->setSize(250, GuiElement::GuiSizeMax);
    ...
    // Main screen section.
    (new GuiLabel(left_panel, "MAIN_SCREEN_LABEL", "Options ecran principal", 30))->addBackground()->setSize(GuiElement::GuiSizeMax, 50);
    ...
    row = new GuiAutoLayout(left_panel, "", GuiAutoLayout::LayoutHorizontalLeftToRight);
    row->setSize(GuiElement::GuiSizeMax, 50);
    (new GuiLabel(row, "GAME_SCANNING_COMPLEXITY_LABEL", "Complexite scan: ", 30))->setAlignment(ACenterRight)->setSize(250, GuiElement::GuiSizeMax);
    ...
    row = new GuiAutoLayout(left_panel, "", GuiAutoLayout::LayoutHorizontalLeftToRight);
    row->setSize(GuiElement::GuiSizeMax, 50);
    (new GuiToggleButton(row, "GAME_FREQUENCIES_TOGGLE", "Frequences laser/bouclier", [](bool value) {
    ...
    (new GuiToggleButton(row, "GAME_SYS_DAMAGE_TOGGLE", "Dommage par systeme", [](bool value) {
    ...
    // Start server button.
    (new GuiButton(right_container, "START_SERVER", "Demarrer scenario", [this]() {
        startScenario();
    }))->setPosition(0, -50, ABottomCenter)->setSize(300, 50);
...
void ServerCreationScreen::selectScenario(string filename)
{
    ...
    variation_names_list = {"Rien"};
    gameGlobalInfo->variation = variation_names_list[0];

    variation_descriptions_list = {"Pas de variation."};
    variation_description->setText("Pas de variation selectionnee. Activer le scenario tel que prevu.");
