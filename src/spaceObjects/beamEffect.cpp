...
/// LASEREffect is a LASER weapon fire effect that will fade after 1 second
...
REGISTER_SCRIPT_SUBCLASS(LASEREffect, SpaceObject)
{
    ...
    REGISTER_SCRIPT_CLASS_FUNCTION(LASEREffect, setTexture);
    REGISTER_SCRIPT_CLASS_FUNCTION(LASEREffect, setLASERFireSound);
    REGISTER_SCRIPT_CLASS_FUNCTION(LASEREffect, setLASERFireSoundPower);
    REGISTER_SCRIPT_CLASS_FUNCTION(LASEREffect, setDuration);
    REGISTER_SCRIPT_CLASS_FUNCTION(LASEREffect, setRing);
}
...
: SpaceObject(1000, "LASEREffect")
{
    ...
    LASER_fire_sound = "sfx/laser_fire.wav";
    LASER_fire_sound_power = 1;
    fire_ring = true;
