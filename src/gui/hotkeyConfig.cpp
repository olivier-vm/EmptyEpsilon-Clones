...
{  // this list includes all Hotkeys and their standard configuration
    ...
    newKey("RLS_0", std::make_tuple("RLS off", ""));
    newKey("RLS_1", std::make_tuple("RLS 1", ""));
    newKey("RLS_2", std::make_tuple("RLS 2", ""));
    newKey("RLS_3", std::make_tuple("RLS 3", ""));
    newKey("RLS_4", std::make_tuple("RLS 4", ""));
    ...
    newKey("INC_WARP", std::make_tuple("Increase WARP distance", ""));
    newKey("DEC_WARP", std::make_tuple("Decrease WARP distance", ""));
    newKey("WARP", std::make_tuple("Initiate WARP", ""));
    ...
    newKey("LASER_SUBSYSTEM_TARGET_NEXT", std::make_tuple("Next LASER subsystem target type", ""));
    newKey("LASER_SUBSYSTEM_TARGET_PREV", std::make_tuple("Previous LASER subsystem target type", ""));
    newKey("LASER_FREQUENCY_INCREASE", std::make_tuple("Increase LASER frequency", ""));
    newKey("LASER_FREQUENCY_DECREASE", std::make_tuple("Decrease LASER frequency", ""));
    ...
    newKey("SELECT_RLS", std::make_tuple("Select RLS system", "Num6"));
    newKey("SELECT_WARP_DRIVE", std::make_tuple("Select WARP drive system", "Num7"));
