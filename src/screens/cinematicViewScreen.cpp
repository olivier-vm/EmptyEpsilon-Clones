...
CinematicViewScreen::CinematicViewScreen()
{
    ...
    camera_lock_toggle = new GuiToggleButton(this, "CAMERA_LOCK_TOGGLE", "Bloquer la camera sur le vaisseau", [this](bool value) {});
    camera_lock_toggle->setValue(true)->setPosition(20, -20, ABottomLeft)->setSize(300, 50)->hide();

    camera_lock_tot_toggle = new GuiToggleButton(this, "CAMERA_LOCK_TOT_TOGGLE", "Bloquer la camera sur la cible du vaisseau", [this](bool value) {});
