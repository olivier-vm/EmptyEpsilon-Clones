...
Instabilite Doppler: %i]], b20_artifact.beta_radiation, b20_artifact.ionic_phase_shift, b20_artifact.gravity_disruption, b20_artifact.doppler_instability))
	...
	insurges_defense_line = {
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(7657, -264940),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(9915, -289620),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(1822, -287037),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(-6615, -285401),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(-18324, -283593),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(-24522, -276878),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(-28138, -268613),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(-23403, -256302),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(-11608, -254149),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(46849, -260262),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(35571, -254924),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(22312, -254063),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(10842, -255239),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(65015, -272745),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(60452, -263189),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(56664, -280494),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(48829, -284454),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(22915, -287381),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(36690, -287554),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(-34202, -259093),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(29547, -294816),
		RLSJammer():setFaction("Insurges"):setRange(18000):setPosition(54372, -255958)
	}
