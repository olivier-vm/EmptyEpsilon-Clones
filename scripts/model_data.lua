...
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(23, 0, -1.8)
...
model:setRadius(100)
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(-1.6, -8, -2)
model:addLASERPosition(-1.6,  8, -2)
...
model:setRadius(140)
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(21, -28.2, -2)
model:addLASERPosition(21,  28.2, -2)
...
model:setRadius(200)
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(34, -17, -7)
model:addLASERPosition(34,  17, -7)
model:addLASERPosition(-5, -33, -1)
model:addLASERPosition(-5,  33, -1)
...
model:setRadius(200)
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(37, -14.5, -3.5)
model:addLASERPosition(37,  14.5, -3.5)
model:addLASERPosition(10, -12, -15)
model:addLASERPosition(10,  12, -15)
model:addLASERPosition(-9, -28, -3)
model:addLASERPosition(-9,  28, -3)
...
model:setRadius(200)
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(22,  22, -4.5)
model:addLASERPosition(22, -22, -4.5)
model:addLASERPosition(12,  22, -4.5)
model:addLASERPosition(12, -22, -4.5)
...
model:setRadius(200)
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(4, -27, -0.5)
model:addLASERPosition(4,  27, -0.5)
...
-- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
model:addLASERPosition(66, -71, 12)
model:addLASERPosition(66, -71, -12)
model:addLASERPosition(66,  71, 12)
model:addLASERPosition(66,  71, -12)
model:addLASERPosition(-32, -71, 12)
model:addLASERPosition(-32, -71, -12)
model:addLASERPosition(-32,  71, 12)
model:addLASERPosition(-32,  71, -12)
model:addLASERPosition(-112, -71, 12)
model:addLASERPosition(-112, -71, -12)
model:addLASERPosition(-112,  71, 12)
model:addLASERPosition(-112,  71, -12)
...
for _, color in ipairs({"Blue", "Green", "Grey", "Red", "White", "Yellow"}) do
    ...
    model:setRadius(30)
    -- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
    model:addLASERPosition(1.8, 0, 0.03)
    model:addLASERPosition(1.8, 0.13, 0.03)
    model:addLASERPosition(1.8,-0.13, 0.03)
    ...
    -- Visual positions of the LASERs/missiletubes (blender: -X, Y, Z)
    model:addLASERPosition(2.4, 0.1, -0.25)
    model:addLASERPosition(2.4,-0.1, -0.25)
    ...
    model:setScale(20)
    model:setRadius(30)
    model:addLASERPosition(1.15, 0.13, -0.03)
    model:addLASERPosition(1.15,-0.13, -0.03)
