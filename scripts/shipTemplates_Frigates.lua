...
This class of ships is normally not fitted with WARP or RLS drives. But in some cases ships are modified to include these, or for certain roles it is build in.
...
template:setLASERWeapon(0, 90, -15, 1200, 8, 6)
template:setLASERWeapon(1, 90,  15, 1200, 8, 6)
...
template:setLASERWeapon(0, 90, -15, 1200, 3, 1)
template:setLASERWeapon(1, 90,  15, 1200, 3, 1)
template:setLASERWeapon(2, 90,  50, 1200, 3, 1)
template:setLASERWeapon(3, 90, -50, 1200, 3, 1)
template:setHull(70)
template:setShields(50, 40)
...
variation:setLASERWeapon(0, 90, -15, 1200, 2.9, 1)
variation:setLASERWeapon(1, 90,  15, 1200, 2.9, 1)
variation:setLASERWeapon(2, 90,  50, 1200, 2.9, 1)
variation:setLASERWeapon(3, 90, -50, 1200, 2.9, 1)
...
template:setLASERWeapon(0, 60, 0, 1200, 3, 2)
template:setHull(50)
...
template:setRadarTrace("radar_piranha.png")
template:setDescription("Long range narrow LASER and some point defense LASERs, broadside missiles. Agile for a frigate")
--						Arc, Dir, Range, CycleTime, Dmg
template:setLASERWeapon(0, 4,   0, 1400.0, 6.0, 4)
template:setLASERWeapon(1,20,   0, 1200.0, 6.0, 4)
template:setLASERWeapon(2,60,   0, 1000.0, 6.0, 4)
template:setLASERWeapon(3,90,   0,  800.0, 6.0, 4)
...
template:addRoomSystem( 1, 0, 1, 1, "WARPDrive")
template:addRoomSystem( 1, 3, 1, 1, "RLS")
...
template:addRoomSystem( 5, 1, 2, 2, "LASERweapons")
...
variation:setDescription([[This combat-specialized Piranha F12 adds mine-laying tubes, combat maneuvering systems, and a WARP drive.]])
...
variation:addRoomSystem(2, 0, 2, 1, "LASERweapons")
variation:addRoomSystem(2, 3, 2, 1, "Maneuver")

variation:addRoomSystem(4, 0, 2, 1, "RLS")
variation:addRoomSystem(4, 3, 2, 1, "WARPDrive")
...
template:setRadarTrace("radar_cruiser.png")
template:setDescription([[The Stalker is a strike ship designed to swoop into battle, deal damage quickly, and get out fast. The Q7 model is fitted with a RLS drive.]])
template:setHull(50)
template:setShields(80, 30, 30, 30)
template:setSpeed(70, 12, 12)
template:setRLSSpeed(700)
template:setLASER(0, 40,-5, 1000.0, 6.0, 6)
template:setLASER(1, 40, 5, 1000.0, 6.0, 6)

variation = template:copy("Stalker R7")
variation:setDescription([[The Stalker is a strike ship designed to swoop into battle, deal damage quickly, and get out fast. The R7 model is fitted with a WARP drive.]])
variation:setRLSSpeed(0)
variation:setWARPDrive(true)
...
variation:setLASER(0, 40, 170, 1200.0, 6.0, 6)
variation:setLASER(1, 40, 190, 1200.0, 6.0, 6)

variation = variation:copy("Flavia P.Falcon"):setType("playership")
variation:setDescription([[The Flavia P.Falcon has a nuclear-capable rear-facing weapon tube and a RLS drive.]])
variation:setHull(100)
variation:setShields(70, 70)
variation:setSpeed(60, 10, 10)
variation:setRLSSpeed(500)
...
variation:addRoomSystem(2, 1, 2, 2, "LASERweapons")
variation:addRoomSystem(2, 3, 2, 2, "Reactor")
variation:addRoomSystem(4, 1, 2, 2, "RLS")
variation:addRoomSystem(4, 3, 2, 2, "WARPDrive")
...
template:setRadarTrace("radar_tug.png")
template:setDescription("WARP/Turret version of Flavia Falcon")
template:setHull(120)
template:setShields(80, 80)
template:setSpeed(55, 9, 10)
--                 Arc, Dir, Range, CycleTime, Dmg
template:setLASER(0, 10, 90, 1200.0, 6.0, 5)
template:setLASER(1, 10,-90, 1200.0, 6.0, 5)
--								Arc, Dir, Rotate speed
template:setLASERWeaponTurret(0, 200,  90, 5)
template:setLASERWeaponTurret(1, 200, -90, 5)
template:setWARPDrive(true)
...
template:addRoomSystem( 2, 2, 2, 2, "RLS")
template:addRoom( 2, 4, 2, 2)
template:addRoomSystem( 4, 1, 1, 4, "Maneuver")
template:addRoom( 5, 0, 2, 2)
template:addRoomSystem( 5, 2, 2, 2, "WARPDrive")
template:addRoomSystem( 5, 4, 2, 2, "LASERweapons")
