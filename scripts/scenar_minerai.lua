...
function init()
	...
	table_minerai[7] = {"Yttrium",0.2,"moyen",5}
	table_minerai[8] = {"Cerium",0.1,"difficile",5}
	table_minerai[9] = {"Praseodyme",0.1,"difficile",5}
	...
	for _, obj in ipairs(getAllObjects()) do
		if obj.typeName == "Asteroid" then
			...
			for _, obj2 in ipairs(getObjectsInRadius(x,y,5000)) do
				if obj2.typeName == "ScanProbe" or obj == player then
