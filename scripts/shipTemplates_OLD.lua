...
--                  Arc, Dir, Range, CycleTime, Dmg
variation:setLASER(0, 10,  35, 1000.0, 6.0, 6)
variation:setLASER(1, 10, -35, 1000.0, 6.0, 6)
--								Arc, Dir, Rotate speed
variation:setLASERWeaponTurret(0, 90,  35, 6)
variation:setLASERWeaponTurret(1, 90, -35, 6)
...
variation:addRoomSystem( 1, 1, 2, 2, "WARPDrive")
variation:addRoomSystem( 1, 3, 2, 1, "FrontShield")
variation:addRoomSystem( 3, 0, 2, 1, "LASERweapons")
variation:addRoomSystem( 3, 1, 3, 1, "RLS")
...
--                  Arc, Dir, Range, CycleTime, Dmg
template:setLASER(0, 60, -15, 1000.0, 6.0, 6)
template:setLASER(1, 60,  15, 1000.0, 6.0, 6)
template:setHull(60)
...
-- Karnack Cruiser mark II
	-- Fabricated by: Repulse shipyards
	-- The sucessor to the widly sucesfull mark I Karnack. This ship has several notable improvements over the original ship, including better armor, slightly improved weaponry and customization by the shipyards. The latter improvement was the most requested feature by several factions once they realized that their old surplus mark I ships were used for less savoury purposes.
...
--                  Arc, Dir, Range, CycleTime, Dmg
variation:setLASER(0, 90, -15, 1000.0, 6.0, 6)
variation:setLASER(1, 90,  15, 1000.0, 6.0, 6)
...
-- The gunship is a ship equiped with a homing missile tube to do initial damage and then take out the enemy with 2 front firing LASERs. It's designed to quickly take out the enemies weaker then itself.
...
template:setDescription("The gunship is a ship equiped with a homing missile tube to do initial damage and then take out the enemy with 2 front firing LASERs. It's designed to quickly take out the enemies weaker then itself.")
--                  Arc, Dir, Range, CycleTime, Dmg
...
variation:setDescription("The advanced gunship is a ship equiped with 2 homing missiles to do initial damage and then take out the enemy with 2 front firing LASERs. It's designed to quickly take out the enemies weaker then itself.")
variation:setTubes(2, 8.0) -- Amount of torpedo tubes

-- The Strikeship is a RLS-drive equiped figher build for quick strikes, it's fast, it's agile, but does not do an extreme amount of damage, and lacks in rear shields.
...
template:setDescription("The Strikeship is a RLS-drive equipped figher build for quick strikes, it's fast, it's agile, but does not do an extreme amount of damage, and lacks in rear shields.")
--                  Arc, Dir, Range, CycleTime, Dmg
...
-- The Advanced Striker is a WARP-drive equipped figher build for quick strikes, it's slow but very agile, but does not do an extreme amount of damage, and lacks in shields. However, due to the WARP drive, it's quick to get into the action.
...
template:setDescription("The Advanced Striker is a WARP-drive equipped figher build for quick strikes, it's slow but very agile, but does not do an extreme amount of damage, and lacks in shields. However, due to the WARP drive, it's quick to get into the action.")
--                  Arc, Dir, Range, CycleTime, Dmg
...
variation:setLASER(0, 10,-15, 1000.0, 6.0, 6)
variation:setLASER(1, 10, 15, 1000.0, 6.0, 6)
--								  Arc, Dir, Rotate speed
variation:setLASERWeaponTurret( 0, 100, -15, 6)
variation:setLASERWeaponTurret( 1, 100,  15, 6)
...
variation:addRoomSystem(0,1,1,1,"LASERweapons")
variation:addRoomSystem(1,1,1,3,"Reactor")
variation:addRoomSystem(2,2,3,1,"RLS")
variation:addRoomSystem(5,2,4,1,"WARPDrive")
...
variation:addDoor(5,4,true)
 ...
 -- The Dreadnought is a flying fortress, it's slow, slow to turn, but packs a huge amount of LASER weapons in the front. Taking it head-on is suicide.
template = ShipTemplate():setName("Dreadnought"):setModel("battleship_destroyer_1_upgraded"):setClass("Dreadnaught","Assault")
template:setRadarTrace("radar_dread.png")
template:setDescription("The Dreadnought is a flying fortress, it's slow, slow to turn, but packs a huge amount of LASER weapons in the front. Taking it head-on is suicide.")
--                  Arc, Dir, Range, CycleTime, Dmg
...
--                  Arc, Dir, Range, CycleTime, Dmg
variation:setLASER(0, 10, -90, 2500.0, 6.1, 4)
variation:setLASER(1, 10, -90, 2500.0, 6.0, 4)
variation:setLASER(2, 10,  90, 2500.0, 5.8, 4)
variation:setLASER(3, 10,  90, 2500.0, 6.3, 4)
variation:setLASER(4, 10, -90, 2500.0, 5.9, 4)
variation:setLASER(5, 10, -90, 2500.0, 6.4, 4)
variation:setLASER(6, 10,  90, 2500.0, 5.7, 4)
variation:setLASER(7, 10,  90, 2500.0, 5.6, 4)
variation:setLASER(8, 10, -90, 2500.0, 6.6, 4)
variation:setLASER(9, 10, -90, 2500.0, 5.5, 4)
variation:setLASER(10, 10,  90, 2500.0, 6.5, 4)
variation:setLASER(11, 10,  90, 2500.0, 6.2, 4)
--								  Arc, Dir, Rotate speed
variation:setLASERWeaponTurret( 0, 120, -90, 6)
variation:setLASERWeaponTurret( 1, 120, -90, 6)
variation:setLASERWeaponTurret( 2, 120,  90, 6)
variation:setLASERWeaponTurret( 3, 120,  90, 6)
variation:setLASERWeaponTurret( 4, 120, -90, 6)
variation:setLASERWeaponTurret( 5, 120, -90, 6)
variation:setLASERWeaponTurret( 6, 120,  90, 6)
variation:setLASERWeaponTurret( 7, 120,  90, 6)
variation:setLASERWeaponTurret( 8, 120, -90, 6)
variation:setLASERWeaponTurret( 9, 120, -90, 6)
variation:setLASERWeaponTurret(10, 120,  90, 6)
variation:setLASERWeaponTurret(11, 120,  90, 6)
...
template:setRadarTrace("radar_missile_cruiser.png")
template:setDescription("The weapons-platform is a stationary platform with LASER-weapons. It's extremely slow to turn, but it's LASER weapons do a huge amount of damage.")
--                  Arc, Dir, Range, CycleTime, Dmg
