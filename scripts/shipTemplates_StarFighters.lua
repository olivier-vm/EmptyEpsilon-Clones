...
template:setLASER(0, 30, 0, 700.0, 4.0, 2)
...
variation:setLASER(0, 30, 0, 900.0, 4.0, 2.5)
...
variation:setLASER(0, 30, 5, 900.0, 4.0, 2.5)
variation:setLASER(1, 30,-5, 900.0, 4.0, 2.5)
variation:setEnergyStorage(400)

variation:setRepairCrewCount(1)
variation:addRoomSystem(3, 0, 1, 1, "Maneuver");
variation:addRoomSystem(1, 0, 2, 1, "LASERWeapons");

variation:addRoomSystem(0, 1, 1, 2, "RearShield");
variation:addRoomSystem(1, 1, 2, 2, "Reactor");
variation:addRoomSystem(3, 1, 2, 1, "RLS");
variation:addRoomSystem(3, 2, 2, 1, "WARPDrive");
...
template:setLASER(0, 35, 0, 800, 5.0, 2.0)
template:setLASER(1, 70, 30, 600, 5.0, 2.0)
template:setLASER(2, 70, -35, 600, 5.0, 2.0)
...
variation:setLASER(3, 35,180, 600, 6.0, 2.0)
...
--                  Arc, Dir, Range, CycleTime, Dmg
variation:setLASER(0, 10, 180, 700, 6.0, 2)
--								  Arc, Dir, Rotate speed
variation:setLASERWeaponTurret( 0, 270, 180, 4)
...
variation:addRoomSystem(4,1,2,1,"LASERweapons")
variation:addRoomSystem(3,2,2,1,"Reactor")
variation:addRoomSystem(2,3,2,1,"RLS")
variation:addRoomSystem(4,3,5,1,"WARPDrive")
